...
const UniversalModal = ({ children, isOpen, closeFnc, content }) => {
  ...
  return (
    ...
    >
      <div className="absolute max-h-[90vh] overflow-y-auto pointer-events-auto bg-primary-text-button-color top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-[24px] items-center flex flex-col py-[50px] px-[25px] md:p-[50px] ">
        <button
