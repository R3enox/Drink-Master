  ...
  return (
    <button
      ...
      className="min-w-[46px] h-[46px] md:min-w-[56px] md:h-[54px] rounded-[40px] 
       hover:bg-filter-scroll-text transition shadow-lg hover:shadow-primary-text-button-color/50 dark:hover:shadow-primary-text-color/50 bg-primary-text-button-color
