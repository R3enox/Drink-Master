...
export const Footer = () => {
  return (
    <footer className="container pt-[40px] border-solid border-t-[1px] border-border-color bg-mobile-bg-footer bg-bottom h-full bg-containe bg-no-repeat md:flex gap-x-[231px] md:pt-[80px] md:bg-tablet-bg-footer lg:bg-desktop-bg-footer">
